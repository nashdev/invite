        ...
        <div className="content">
          ...
          <section className={css.mainSection}>
            <section className={css.subSection}>
              ...
              <p>
                ...
                practicing, and working in technology. We recognize and
            ...
            <section className={css.subSection}>
              ...
              <p>
                ...
                should not presume anything you say here will remain private, so
                act accordingly. Protect IP and legally-protected information.
                <br />
                For attribution of specific content found on this Slack, we ask
                that you ask the originator of the content for permission.
              </p>
            </section>
            <section className={css.subSection}>
              <h2>
                <strong>1.3 Not For Profit</strong>
              </h2>
              <p>
                ...
                marketing, or other solicitation, except in channels dedicated
                to that purpose.
              </p>
              <p>
              ...
              <p>
                ...
                Tennessee area, or 100% remote. The goal of this channel is to
                grow our local community, not to take talent from the area.
              </p>
              <p>
                Non-obvious commercial activity includes things such as
                well-intentioned user surveys of a specific channel or
                responding to a request for tools or services with information
                about what your company provides. In these situations, we ask
                that you:
              </p>
              <ul>
                <li>
              ...
              <p>
                ...
                please ask and calibrate in <code>#meta</code>.
              </p>
            </section>
            ...
            <section className={css.subSection}>
              ...
              <p>
                ...
                bring it to the attention of an admin. We want to hear from you
                about anything that you feel is disrespectful, threatening, or
                just something that could make someone feel distressed in any
                way. We will listen and work to resolve the matter.
              </p>
            </section>
            ...
            <section className={css.subSection}>
              ...
              <p>
                ...
                actions, and apologize accordingly. No one is perfect, and even
                well-intentioned people make mistakes. What matters is how you
                handle them and that you avoid repeating them in the future.
              </p>
            </section>
            ...
            <section className={css.subSection}>
              ...
              <p>
                ...
                the best thing to do is to ask a disrespectful individual to
                leave, we will do so.
              </p>
            </section>
          </section>
          ...
          <section className={css.mainSection}>
            ...
            <section className={css.subSection}>
              ...
              <p>
                ...
                to an admin deleting the message (or messages) that violate the
                CoC. Messages that are most likely to be deleted are commercial
                solicitations, disrespectful messages to other members, or links
                to disturbing or distressing content without appropriate
                measures to warn of or hide the content (including image uploads
                and unfurls).
              </p>
              <p>
                Ideally, another NashDev member notices this content and
                contacts the original poster, who then modifies or deletes the
                message so that it is no longer problematic. In this case, no
                further admin action is required. If admin action is desired,
                due to lack of response or any other reason, an admin will
                notify the original poster of the violation and the need to
                reword or remove the problematic message. The admin will also
                specify a time after which admin action will be taken to delete
                the content if it is not addressed. This time may be as little
                as a few minutes, or as much as 24 hours.
              </p>
              <p>
                The determination of how much time is allowed is up to the admin
                team, but the following context will be used to help determine
              ...
              <p>
                Additional consequences beyond the removal of content are up to
                the admin team, per the same incident process found in the
                following section “Incident Process”.
              </p>
            </section>
          </section>
          ...
          <section className={css.mainSection}>
            ...
            <section className={css.subSection}>
              ...
              <p>
                ...
                channel and are wondering if it’s acceptable, please first
                consult the CoC.
              </p>
              <p>
            ...
            <section className={css.subSection}>
              ...
              <section className={css.secondarySubSection}>
                ...
                <ul>
                  ...
                  <li>
                    ...
                    If an incident involved only 2 people, this is not possible.
              ...
              <section className={css.secondarySubSection}>
                ...
                <p>
                  In both cases, the reporter needs to provide the following
                ...
                <ul>
                  <li>
                    Work to determine whether this is a raised concern or a
                ...
                <p>
                  For any type of suspension, the admins will conduct a private
                  vote based on the incident. Majority wins. With the defined
                  incident and consequence in hand, the admin will present the
                ...
                <p>
                  For <strong>Strikes</strong>, members will be alerted to the
                  strike policy and the number of current strikes they have.
                </p>
                <p>
                  For <strong>Do Not Contact</strong>, members will receive the
                  time period when they can not contact other member(s)
                </p>
                <p>
                  For <strong>Temporary Suspension</strong>, members will
                  receive the time period when they can not be a part of NashDev
                  Slack.
                </p>
                <p>
                  For <strong>Permanent Suspension</strong>, members will
                  receive the content above and then permanently removed from
                  NashDev Slack.
                </p>
                <p>
                  The Administrators are committed to resolve incidents within
                  five working days.
                </p>
              </section>
            </section>
          ...
          <section className={css.mainSection}>
            <p className={css.attribution}>
              After reviewing several COC options, this version was adapted from
              the{" "}
